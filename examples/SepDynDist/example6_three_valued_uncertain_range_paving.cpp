/********************************************************************************************
 * @file    example6_three_valued_paving_interval.cpp
 * @author  Damien ESNAULT (PhD student, ENSTA / Lab-STICC)
 * @date    2025
 * @brief   Three-valued coverage perception using SepDynDist with an uncertain interval and paving.
 *
 * @details
 * This example illustrates how to use the SepDynDist separator in a three-valued
 * perception context (inside / outside / uncertain) where the uncertain range
 * is represented by an interval, together with a paving algorithm.
 *
 * Scenario:
 ...
 *   - undetermined (uncertain range defined by the interval around the detection).
 *
 * Goal:
 * Demonstrate how to:
 *   - instantiate a SepDynDist separator with a distance interval and an uncertain interval,
 ...
 * - The uncertain range interval allows modeling sensor uncertainty with more flexibility.
...
int main()
{
    ...
    // Create the separator for the given trajectory, detection range, and uncertain interval
    ...
    // Outer circle: upper bound of uncertain interval
    // Upper circle: detection range upper bound
    // Lower circle: detection range lower bound
    // Inner circle: lower bound of uncertain interval
