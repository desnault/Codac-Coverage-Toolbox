/*
 * @file example1_covered_area_binary_range.cpp
 * @brief Example of computing the covered area using SepDynDiskProj with a binary (disk) sensor.
 *
 * This example shows how to:
 * 1. Define a 3D trajectory for the robot.
 * 2. Convert the trajectory into a tube (TubeVector) for interval-based projection.
 * 3. Define a binary detection range (disk) for the sensor.
 ...
 * for a sensor whose coverage is defined by a fixed disk (binary coverage).
 */
...
int main()
{
    ...
    // SepDynDiskProj combines SepDynDisk (disk coverage along trajectory) with SepProj
    ...
    // - Detected (inside the sensor coverage)
    // - Not detected (outside the sensor coverage)
